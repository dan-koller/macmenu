...
enum WindowAction: Int, Codable {
    ...
    var resizes: Bool {
        ...
        case .moveUp, .moveDown, .moveLeft, .moveRight: return Constants.resizeOnDirectionalMove.enabled
        default: return true
        }
    }
    ...
    var gapSharedEdge: Edge {
        ...
        case .moveUp: return Constants.resizeOnDirectionalMove.enabled ? .bottom : .none
        case .moveDown: return Constants.resizeOnDirectionalMove.enabled ? .top : .none
        case .moveLeft: return Constants.resizeOnDirectionalMove.enabled ? .right : .none
        case .moveRight: return Constants.resizeOnDirectionalMove.enabled ? .left : .none
        default:
            return .none
        }
    }
    ...
    var gapsApplicable: Dimension {
        ...
        case .moveLeft, .moveRight:
            return Constants.resizeOnDirectionalMove.enabled ? .horizontal : .none;
        case .maximize:
            return Constants.applyGapsToMaximize.userDisabled ? .none : .both;
        case .maximizeHeight:
            return Constants.applyGapsToMaximizeHeight.userDisabled ? .none : .vertical;
