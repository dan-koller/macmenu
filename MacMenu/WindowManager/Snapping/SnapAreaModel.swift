...
class SnapAreaModel {
    ...
    var landscape: [Directional:SnapAreaConfig] {
        Constants.landscapeSnapAreas.typedValue ?? SnapAreaModel.defaultLandscape
    }
    var portrait: [Directional:SnapAreaConfig] {
        Constants.portraitSnapAreas.typedValue ?? SnapAreaModel.defaultPortrait
    }
    ...
    func setLandscape(directional: Directional, snapAreaConfig: SnapAreaConfig?) {
        ...
        Constants.landscapeSnapAreas.typedValue = newConfig
    }
    
    func setPortrait(directional: Directional, snapAreaConfig: SnapAreaConfig?) {
        var newConfig = portrait
        newConfig[directional] = snapAreaConfig
        Constants.portraitSnapAreas.typedValue = newConfig
    }
    
    func migrate() {
        if Constants.sixthsSnapArea.userEnabled {
        ...
        let ignoredSnapAreas = SnapAreaOption(rawValue: Constants.ignoredSnapAreas.value)
